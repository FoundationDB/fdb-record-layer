...
class TupleOrderingTest {
    ...
    private static final byte[][] INVERT_BYTES = {
        ...
        new byte[] { 0x00 }, new byte[] { 0x7F, 0x7F, (byte)0x86 },
        new byte[] { 0x01 }, new byte[] { 0x7F, 0x3F, (byte)0x86 },
        new byte[] { 0x01, 0x02 }, new byte[] { 0x7F, 0x3F, 0x3F, (byte)0x85 },
        new byte[] { 0x01, 0x02, 0x00 }, new byte[] { 0x7F, 0x3F, 0x3F, 0x7F, (byte)0x84 },
        new byte[] { 0x01, 0x02, 0x03 }, new byte[] { 0x7F, 0x3F, 0x3F, 0x4F, (byte)0x84 },
        new byte[] { 0x01, 0x02, (byte)0xFF }, new byte[] { 0x7F, 0x3F, 0x20, 0x0F, (byte)0x84 },
        new byte[] { 0x01, 0x02, (byte)0xFF, 0x00 }, new byte[] { 0x7F, 0x3F, 0x20, 0x0F, 0x7F, (byte)0x83 },
        new byte[] { 0x01, 0x02, (byte)0xFF, 0x01 }, new byte[] { 0x7F, 0x3F, 0x20, 0x0F, 0x77, (byte)0x83 },
        new byte[] { (byte)0xFF }, new byte[] { 0x00, 0x3F, (byte)0x86 },
    };
