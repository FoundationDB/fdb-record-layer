...
public class FDBDirectory extends Directory  {
    ...
    public byte[] getTermMetadata(@Nonnull final Tuple key) {
        return context.asyncToSync(LuceneEvents.Waits.WAIT_LUCENE_GET_FILE_REFERENCE, getTermMetadataAsync(key));
    }
    ...
    public byte[] getTerm(@Nonnull final Tuple keyTuple) {
        ...
        return context.asyncToSync(LuceneEvents.Waits.WAIT_LUCENE_GET_FILE_REFERENCE, getTermAsync(keyTuple));
    }
