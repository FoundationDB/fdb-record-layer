...
/**
 * This class wraps a FieldsProducer.
 *
 */
public class LuceneOptimizedPostingsFieldsProducer extends FieldsProducer {
    ...
    public LuceneOptimizedPostingsFieldsProducer(final SegmentReadState state) {
        this.state = state;
        this.postingsReader = new LuceneOptimizedPostingsReader_V2(state);
    ...
    public Terms terms(String field) throws IOException {
        return new LuceneOptimizedTerms(state.fieldInfos.fieldInfo(field), directory, state, postingsReader);
    }
