 ...
 * any resources. Since no real locking occurs, this should only be used when:</p>
 * <ul>
 *     <li>The writer will not perform any flush operations</li>
 *     <li>The writer will not commit changes</li>
 *     <li>All operations are immediately visible to readers without flushing</li>
 * </ul>
 */
