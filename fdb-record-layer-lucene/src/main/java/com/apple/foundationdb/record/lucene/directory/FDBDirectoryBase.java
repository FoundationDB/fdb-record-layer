 ...
 * class with FDB-specific methods. This allows for delegation patterns where wrapper
 * directories can delegate to an underlying FDBDirectory implementation.
 */
