...
public class LuceneOptimizedStats {
    ...
    LuceneOptimizedStats(String segment, String field) {
        this.segment = segment;
        this.field = field;
    }

    void startBlock(LuceneOptimizedSegmentTermsEnumFrame frame, boolean isFloor) {
        totalBlockCount++;
        if (isFloor) {
    ...
    void endBlock(LuceneOptimizedSegmentTermsEnumFrame frame) {
