/*
 * LuceneOptimizedSegmentTermsEnumFrame.java
 *
...
final class LuceneOptimizedSegmentTermsEnumFrame {
    // Our index in stack[]:
    final int ord;
    ...
    private final LuceneOptimizedSegmentTermsEnum ste;
    private final int version;

    public LuceneOptimizedSegmentTermsEnumFrame(LuceneOptimizedSegmentTermsEnum ste, int ord) throws IOException {
        this.ste = ste;
        this.ord = ord;
