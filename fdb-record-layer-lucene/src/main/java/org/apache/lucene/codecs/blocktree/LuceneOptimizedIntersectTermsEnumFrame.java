/*
 * LuceneOptimizedIntersectTermsEnumFrame.java
 *
...
final class LuceneOptimizedIntersectTermsEnumFrame {
    final int ord;
    long fp;
    long fpOrig;
    long fpEnd;
    ...
    private final LuceneOptimizedIntersectTermsEnum ite;
    private final int version;

    public LuceneOptimizedIntersectTermsEnumFrame(LuceneOptimizedIntersectTermsEnum ite, int ord) throws IOException {
        this.ite = ite;
        this.ord = ord;
