...
public abstract class QueryParserBase extends QueryBuilder implements CommonQueryParserConfiguration {
     ...
     * score c) avoids any {@link BooleanQuery.TooManyClauses} exception. However, if your application really needs
    ...
    protected Query newPrefixQuery(Term prefix) {
        final PrefixQuery result = new PrefixQuery(prefix);
        result.setRewriteMethod(multiTermRewriteMethod);
        return result;
    }
    ...
    protected Query newRangeQuery(
        ...
        final TermRangeQuery result = new TermRangeQuery(field, start, end, startInclusive, endInclusive);
        result.setRewriteMethod(multiTermRewriteMethod);
        return result;
    }
    ...
    protected Query newWildcardQuery(Term t) {
        final WildcardQuery result = new WildcardQuery(t, determinizeWorkLimit);
        result.setRewriteMethod(multiTermRewriteMethod);
        return result;
    }
