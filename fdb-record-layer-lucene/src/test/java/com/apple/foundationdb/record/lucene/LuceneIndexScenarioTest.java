...
/**
 * Runs the shared index scenario framework against a Lucene index.
 */
@Tag(Tags.RequiresFDB)
public class LuceneIndexScenarioTest extends FDBRecordStoreConcurrentTestBase {
