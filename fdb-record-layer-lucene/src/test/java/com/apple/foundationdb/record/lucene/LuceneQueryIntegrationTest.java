...
public class LuceneQueryIntegrationTest extends FDBRecordStoreQueryTestBase {
    ...
    void notLucene() throws Exception {
        ...
        try (FDBRecordContext context = openContext()) {
            ...
            Assertions.assertEquals(71592145, plan.planHash(PlanHashable.PlanHashKind.LEGACY));
            Assertions.assertEquals(-1378983311, notPlan.planHash(PlanHashable.PlanHashKind.LEGACY));
        }
    }
}
