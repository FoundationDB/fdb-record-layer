...
* **Feature** Record store maintains additional meta-data about the state of an index (cause, time entered, etc.) [(Issue #506)](https://github.com/FoundationDB/fdb-record-layer/issues/506)
