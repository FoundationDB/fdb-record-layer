...
* **Feature** Error messages for `RecordQueryPlanComplexityException` now put logging details in the logging keys including an abbreviated plan description [(Issue #3167)](https://github.com/FoundationDB/fdb-record-layer/issues/3167)
