...
* **Feature** Create an implementation of the Planner Debugger that issues log messages [(Issue #1405)](https://github.com/FoundationDB/fdb-record-layer/issues/1405)
