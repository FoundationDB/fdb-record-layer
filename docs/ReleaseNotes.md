...
* **Bug fix** Online Indexing: Include SynchronizedSessionLockedException as a reason to decrease scanned records limit [(Issue #1977)](https://github.com/FoundationDB/fdb-record-layer/issues/1977)
