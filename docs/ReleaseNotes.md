...
* **Feature** Support synchronized sessions, where only one of them are allowed to work at a time [(Issue #637)](https://github.com/FoundationDB/fdb-record-layer/issues/637)
