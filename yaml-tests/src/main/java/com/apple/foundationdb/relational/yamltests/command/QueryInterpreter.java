...
public final class QueryInterpreter {
    ...
    private QueryInterpreter(@Nonnull final Reference reference, @Nonnull String query, @Nonnull final YamlExecutionContext executionContext) {
        this.query = query;
    ...
    public static QueryInterpreter withQueryString(@Nonnull final Reference reference, @Nonnull String query, @Nonnull final YamlExecutionContext executionContext) {
