    ...
    private void checkMetrics(final @Nonnull String currentQuery,
        ...
        final var actualInfo = PlannerMetricsProto.Info.newBuilder()
                ...
                .setCountersAndTimers(PlannerMetricsProto.CountersAndTimers.newBuilder()
                        ...
                        .setInsertYieldTimeNs(actualPlannerMetrics.getLong(6))
                        .setInsertYieldNewCount(actualPlannerMetrics.getLong(7))
                        .setInsertYieldReusedCount(actualPlannerMetrics.getLong(8))
                        .setInsertMemoizeTimeNs(actualPlannerMetrics.getLong(9))
                        .setInsertMemoizeNewCount(actualPlannerMetrics.getLong(10))
                        .setInsertMemoizeReusedCount(actualPlannerMetrics.getLong(11)))
                .build();
