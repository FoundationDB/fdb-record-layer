...
Welcome to the FoundationDB Record Layer community, and thank you for contributing! The following guide outlines the basics of how to get involved. For a tutorial on how to set up your development environment, build the project, and run your tests, refer to
the [Building the Record Layer](https://foundationdb.github.io/fdb-record-layer/Building.html) guide.
...
or posting to the forums. Instead, use GitHub's private vulnerability reporting to
[report a vulnerability](https://github.com/FoundationDB/fdb-record-layer/security/advisories/new).
Only the maintainers can see the report, and we will follow up with you there.
