...
public class TestUtils {
    public static void loadEmbeddedDriver() throws RelationalException {
        final FDBDatabase fdbDb = FDBDatabaseFactory.instance().getDatabase(null);
        ...
        try {
            final EmbeddedRelationalDriver registeredDriver = new EmbeddedRelationalDriver(RecordLayerEngine.makeEngine(
                    rlConfig,
