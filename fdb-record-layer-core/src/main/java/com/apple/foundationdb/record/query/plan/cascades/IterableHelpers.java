...
public class IterableHelpers {
     ...
     */
    public static <T, R> Iterable<R> flatMap(Iterable<T> source, final Function<? super T, ? extends Iterable<R>> mapper) {
     ...
     */
    public static <T, R> Iterable<R> map(Iterable<T> source, final Function<? super T, R> mapper) {
     ...
     */
    public static <T> Iterable<T> orElseOf(Iterable<T> source, final T value) {
     ...
     */
    public static <T> Iterable<T> orElse(Iterable<T> source, final Iterable<T> otherIterable) {
