 ...
 *
 * <p>In the {@code WITH ORDINALITY} variant, {@code EXPLODE} also generates ordinals of the array elements, as a second
 * anonymous field of that struct. The ordinals are <em>0-based</em>.
 *
...
public class RecordQueryExplodePlan extends AbstractRelationalExpressionWithoutChildren implements RecordQueryPlanWithNoChildren {
    ...
    public <M extends Message> RecordCursor<QueryResult> executePlan(@Nonnull final FDBRecordStoreBase<M> store,
        ...
        // Produce a struct per list element: the element, and its 0-based ordinal in the WITH ORDINALITY case.
