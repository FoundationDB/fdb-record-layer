...
public class Bindings {
     ...
     * constraint matching against a value-free context) can catch precisely this case without also swallowing other
     * {@link RecordCoreException}s such as {@code SemanticException}.
     */
