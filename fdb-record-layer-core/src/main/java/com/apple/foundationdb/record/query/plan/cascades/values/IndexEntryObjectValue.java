...
public class IndexEntryObjectValue extends AbstractValue implements LeafValue, Value.RangeMatchableValue {
    ...
    public <M extends Message> Object eval(@Nullable final FDBRecordStoreBase<M> store, @Nonnull final EvaluationContext context) {
        final var indexEntry = Objects.requireNonNull((IndexEntry)context.getBinding(Bindings.BindingKind.CORRELATION, indexEntryAlias));
    ...
    public static String bindingName() {
        return Bindings.BindingKind.CORRELATION.bindingName(Quantifier.current().getId());
    }
