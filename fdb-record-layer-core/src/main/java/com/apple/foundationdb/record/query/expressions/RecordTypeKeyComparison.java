...
public class RecordTypeKeyComparison implements ComponentWithComparison {
    ...
    /**
     * A {@link Comparisons.Comparison} representing matching a specific record type. Typically,
     * this will be generated by the planner to represent a scan that matches against a
     * {@link com.apple.foundationdb.record.metadata.expressions.RecordTypeKeyExpression} in
     * order to limit the types of records queried.
     */
    ...
    public static class RecordTypeComparison implements Comparisons.Comparison {
        ...
        /**
         * Create a comparison representing matching a specific record type.
         * @param recordTypeName the name of the record type to compare against
         */
        @API(API.Status.INTERNAL)
