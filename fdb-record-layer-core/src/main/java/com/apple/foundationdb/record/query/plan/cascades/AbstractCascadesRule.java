...
/**
 * Classes that inherit from <code>AbstractCascadesRule</code> form the base of the Cascades planning system. During the planning
 ...
 * <br>
 * A <code>AbstractCascadesRule</code> should not store state between successive calls to {@link #onMatch(PlannerRuleCall)},
