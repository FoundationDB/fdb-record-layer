...
public class QuantifiedObjectValue extends AbstractValue implements QuantifiedValue {
    ...
    private QuantifiedObjectValue(final CorrelationIdentifier alias, final Type resultType) {
        this.alias = alias;
    ...
    public <M extends Message> Object eval(@Nullable final FDBRecordStoreBase<M> store, final EvaluationContext context) {
        ...
        final var binding = (QueryResult)obj;
    ...
    @Override
    public PQuantifiedObjectValue toProto(final PlanSerializationContext serializationContext) {
    ...
    public static QuantifiedObjectValue fromProto(final PlanSerializationContext serializationContext,
                                                  final PQuantifiedObjectValue quantifiedObjectValue) {
    ...
    public static QuantifiedObjectValue of(final Quantifier quantifier) {
        return new QuantifiedObjectValue(quantifier.getAlias(), quantifier.getFlowedObjectType());
    }

    public static QuantifiedObjectValue of(final CorrelationIdentifier alias, final Type resultType) {
        return new QuantifiedObjectValue(alias, resultType);
    }

    public static boolean isSimpleQuantifiedObjectValueOver(final Value value,
                                                            final CorrelationIdentifier alias) {
        return (value instanceof QuantifiedObjectValue qov) && qov.getAlias().equals(alias);
    }
    ...
    public static class Deserializer implements PlanDeserializer<PQuantifiedObjectValue, QuantifiedObjectValue> {
        ...
        @Override
        public QuantifiedObjectValue fromProto(final PlanSerializationContext serializationContext,
                                               final PQuantifiedObjectValue quantifiedObjectValueProto) {
