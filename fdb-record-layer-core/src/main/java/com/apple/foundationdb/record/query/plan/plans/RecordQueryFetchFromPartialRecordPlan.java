...
public class RecordQueryFetchFromPartialRecordPlan implements RecordQueryPlanWithChild {
    ...
    public <M extends Message> RecordCursor<FDBQueriedRecord<M>> executePlan(@Nonnull final FDBRecordStoreBase<M> store,
        ...
        return store.fetchIndexRecords(
                getChild().execute(store, context, continuation, executeProperties)
    ...
    public Value getResultValue() {
        return new QueriedValue(); // TODO find out the type for the fetched record and set it here
    }
