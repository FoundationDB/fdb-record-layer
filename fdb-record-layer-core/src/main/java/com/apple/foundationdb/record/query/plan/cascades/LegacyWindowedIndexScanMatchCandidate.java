 ...
 */
public class LegacyWindowedIndexScanMatchCandidate implements ScanWithFetchMatchCandidate, WithBaseQuantifierMatchCandidate {
    /**
    ...
    public LegacyWindowedIndexScanMatchCandidate(@Nonnull Index index,
