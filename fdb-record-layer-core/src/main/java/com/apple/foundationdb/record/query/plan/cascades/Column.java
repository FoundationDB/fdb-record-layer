...
public class Column<V extends Value> implements PlanHashable {
    ...
    public int planHash(@Nonnull final PlanHashMode hashMode) {
        ...
        // TODO: we should revisit normalisation of field names and how they contribute the this hash calculation.
        if (Field.isAutoGenerated(getField().getFieldName())) {
            ...
            return PlanHashable.objectsPlanHash(hashMode, getField().getFieldNameOptional(),
                    getField().getFieldIndexOptional(), getValue());
        }
    }
}
