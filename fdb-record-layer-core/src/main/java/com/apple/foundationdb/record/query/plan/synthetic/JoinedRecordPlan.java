...
class JoinedRecordPlan implements SyntheticRecordFromStoredRecordPlan  {
    ...
    protected static class JoinedType implements PlanHashable {
        ...
        public JoinedType(JoinedRecordType.JoinConstituent constituent, List<BindingPlan> bindingPlans) {
            this.constituent = constituent;
            this.bindingPlans = bindingPlans;
        }

        public <M extends Message> EvaluationContext bind(EvaluationContext context, @Nullable FDBStoredRecord<M> record) {
    ...
    protected static class BindingPlan implements PlanHashable {
        ...
        public BindingPlan(String name, KeyExpression expression, boolean singleton) {
            this.name = name;
    ...
    public JoinedRecordPlan(JoinedRecordType joinedRecordType, List<JoinedType> joinedTypes, List<RecordQueryPlan> queries) {
    ...
    @SuppressWarnings("PMD.CloseResource")
    private RecordCursor<EvaluationContext> query(int depth, FDBRecordStore store, EvaluationContext context,
    ...
    private RecordCursor<EvaluationContext> nest(int depth, int pipelineSize, FDBRecordStore store, EvaluationContext context,
                                                 @Nullable byte[] continuation, ExecuteProperties executeProperties) {
    ...
    private FDBSyntheticRecord toSyntheticRecord(EvaluationContext context) {
