/*
 * LogicalToPhysicalScanRuleOld.java
 *
...
public class LogicalToPhysicalScanRuleOld extends PlannerRule<IndexEntrySourceScanExpression> {
    ...
    public LogicalToPhysicalScanRuleOld() {
        super(root);
    }
