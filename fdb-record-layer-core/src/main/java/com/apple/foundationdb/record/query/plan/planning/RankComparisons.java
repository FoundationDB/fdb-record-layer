        ...
        if (requiredIndexTypes != null) {
            ...
            if (matchingIndex.isPresent()) {
                ...
                if (!operand.createsDuplicates() && !comparisonType.isUnary()) {
                    bindingName = Bindings.BindingKind.RANK.bindingName(Integer.toString(counter.getAndIncrement()));
                    Comparisons.Comparison substituteComparison = new Comparisons.ParameterComparison(comparisonType, bindingName, Bindings.BindingKind.RANK);
