 ...
 */
public class OAggregateValue<T, R> extends DerivedValue {
     ...
     */
    OAggregateValue(@Nonnull final Value child, @Nonnull final AggregateType aggregateType, @Nonnull final Function<Value, RecordValueAccumulator<T, R>> accumulatorFunction) {
    ...
    public String toString() {
        return "OAggregateValue: " + aggregateType.name() + '(' + getChild() + ')';
    }
    ...
    public boolean equals(final Object o) {
        ...
        final OAggregateValue<?, ?> that = (OAggregateValue<?, ?>)o;
