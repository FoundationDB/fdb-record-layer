...
public class MatchableSortExpression implements RelationalExpressionWithChildren, InternalPlannerGraphRewritable {
    ...
    /**
     * This synthesizes a list of {@link LogicalOrderingPart}s from the current partial match and the ordering information
     ...
     */
    @Nonnull
    private List<LogicalOrderingPart> forPartialMatch(@Nonnull PartialMatch partialMatch) {
