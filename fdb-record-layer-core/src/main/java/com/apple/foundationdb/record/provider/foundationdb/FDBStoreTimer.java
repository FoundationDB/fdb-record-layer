...
public class FDBStoreTimer extends StoreTimer {
    ...
    public enum Events implements StoreTimer.Event {
        ...
        QUERY_SELECTION("select one plan for execution"),
    ...
    public enum Counts implements Count {
        ...
        /** The number of query plans that include an {@link com.apple.foundationdb.record.query.plan.plans.RecordQueryComparatorPlan}. */
        ...
        /** The number of query plans that include an {@link com.apple.foundationdb.record.query.plan.plans.RecordQuerySelectorPlan}. */
