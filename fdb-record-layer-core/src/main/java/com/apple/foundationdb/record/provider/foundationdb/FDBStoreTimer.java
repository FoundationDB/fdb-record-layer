...
public class FDBStoreTimer extends StoreTimer {
    ...
    public enum EventAggregates implements Aggregate, Event {
        ...
        WRITES("writes",
                ...
                Events.LOAD_RECORD_STORE_INFO,
                Events.SAVE_RECORD,
                Events.SAVE_INDEX_ENTRY,
                Events.MUTATE_INDEX_ENTRY,
                Events.SCOPED_DIRECTORY_LAYER_CREATE,
                Events.EXTENDED_DIRECTORY_LAYER_CREATE,
                Events.INTERNING_LAYER_CREATE),
        DELETES("deletes",
                Events.DELETE_RECORD,
                Events.DELETE_INDEX_ENTRY),
        ;
        @Nonnull
        private final String title;
        @Nonnull
