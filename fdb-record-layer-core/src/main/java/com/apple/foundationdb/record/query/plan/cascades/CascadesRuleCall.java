 ...
 * via the {@link #yieldResult(Reference)} method, which consists primarily of manipulating the implicit a memo data
 * structure defined by {@link Reference}s and {@link RelationalExpression}s.
 * <br>
 * An invoked rule can in turn call {@link #yieldFinalExpression} or {@link #yieldPartialMatch} to either declare a new resulting
...
public class CascadesRuleCall implements PlannerRuleCall<Reference>, Memoizer {
    ...
    public void yieldResult(@Nonnull final Reference expressionReference) {
    ...
    public void yieldExpression(@Nonnull final RelationalExpression expression) {
    ...
    public void yieldExpressions(@Nonnull final Set<? extends RelationalExpression> expressions) {
        for (final RelationalExpression expression : expressions) {
            yieldExpression(expression, false);
        }
    }
    ...
    public void yieldMixedExpressions(@Nonnull final Set<? extends RelationalExpression> expressions) {
        for (final RelationalExpression expression : expressions) {
            yieldExpression(expression, expression instanceof RecordQueryPlan);
        }
    }
