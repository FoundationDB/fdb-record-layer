 ...
 * via the {@link #yieldExpression(ExpressionRef)} method, which consists primarily of manipulating the implicit a memo data
...
public class CascadesRuleCall implements PlannerRuleCall<ExpressionRef<? extends RelationalExpression>>, Memoizer {
    ...
    public void yieldExpression(@Nonnull ExpressionRef<? extends RelationalExpression> expressionReference) {
