 ...
 * they belong in an enclosing {@link SelectExpression}. Note that {@code ON} predicates have different semantics from
 * {@code WHERE} predicates: they determine match/null-padding rather than row filtering. For this reason
 * {@code OuterJoinExpression} does not implement {@link RelationalExpressionWithPredicates}.
 *
 * <p><b>Current limitation:</b> {@link JoinType#FULL FULL OUTER JOIN} is defined here to allow the model to represent
 * full outer joins, but no planning rules support it yet.
 */
