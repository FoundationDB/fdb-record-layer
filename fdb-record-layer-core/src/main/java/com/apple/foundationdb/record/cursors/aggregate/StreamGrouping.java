...
public class StreamGrouping<M extends Message> {
    ...
    public StreamGrouping(@Nonnull final DynamicSchema dynamicSchema,
        ...
        this.accumulator = aggregateValue.createAccumulator(dynamicSchema);
        this.store = store;
     ...
     * </UL>
     *
     * @param currentObject the next record to process
     *
    ...
    private void finalizeGroup(Object nextGroup) {
        ...
        accumulator = aggregateValue.createAccumulator(dynamicSchema);
    }
