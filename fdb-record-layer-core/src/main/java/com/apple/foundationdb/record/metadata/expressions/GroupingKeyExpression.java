...
public class GroupingKeyExpression extends BaseKeyExpression implements KeyExpressionWithChild {
    ...
    public KeyExpression normalizeForPlannerOld(@Nonnull Source source, @Nonnull List<String> fieldNamePrefix) {
        return new GroupingKeyExpression(wholeKey.normalizeForPlannerOld(source, fieldNamePrefix), groupedCount);
    }
    ...
    public ExpandedPredicates normalizeForPlanner(@Nonnull final CorrelationIdentifier baseAlias,
        ...
        return wholeKey.normalizeForPlanner(baseAlias, typeSupplier, fieldNamePrefix);
    }
