...
public class EmptyComparison extends BaseRepeatedField implements ComponentWithNoChildren {
    ...
    public GraphExpansion expand(@Nonnull final Quantifier.ForEach baseQuantifier,
        ...
        List<String> fieldNames = ImmutableList.<String>builder()
                ...
                .add(getFieldName())
                .build();
        return GraphExpansion.ofPredicate(FieldValue.ofFieldNames(baseQuantifier.getFlowedObjectValue(), fieldNames).withComparison(Comparisons.LIST_EMPTY));
    }
    ...
    public int planHash(@Nonnull final PlanHashMode mode) {
        switch (mode.getKind()) {
            ...
            case FOR_CONTINUATION:
                return PlanHashable.objectsPlanHash(mode, BASE_HASH, isEmpty);
            default:
