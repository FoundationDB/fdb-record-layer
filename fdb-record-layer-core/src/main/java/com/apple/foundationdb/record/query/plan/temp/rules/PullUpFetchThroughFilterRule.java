/*
 * PullUpFetchThroughFilterRule.java
 *
...
public class PullUpFetchThroughFilterRule extends PlannerRule<LogicalDistinctExpression> {
    @Nonnull
    ...
    public PullUpFetchThroughFilterRule() {
        super(root);
    }
