...
public class MergeFetchIntoCoveringIndexRule extends PlannerRule<RecordQueryFetchFromPartialRecordPlan> {
    @Nonnull
    private static final ExpressionMatcher<RecordQueryCoveringIndexPlan> innerPlanMatcher = TypeMatcher.of(RecordQueryCoveringIndexPlan.class);
    @Nonnull
    private static final ExpressionMatcher<RecordQueryFetchFromPartialRecordPlan> root =
            TypeMatcher.of(RecordQueryFetchFromPartialRecordPlan.class, QuantifierMatcher.forEach(innerPlanMatcher));
    ...
    public void onMatch(@Nonnull PlannerRuleCall call) {
        final RecordQueryCoveringIndexPlan innerPlan = call.get(innerPlanMatcher);
        call.yield(call.ref(innerPlan.getIndexPlan()));
    }
}
