...
public class ImplementDistinctUnionRule extends PlannerRule<LogicalDistinctExpression> {
    @Nonnull
    private static final ExpressionMatcher<RecordQueryPlan> unionLegExpressionMatcher = TypeMatcher.of(RecordQueryPlan.class, AllChildrenMatcher.allMatching(ReferenceMatcher.anyRef()));
    @Nonnull
    private static final ExpressionMatcher<LogicalUnorderedUnionExpression> unionExpressionMatcher =
            TypeMatcher.of(LogicalUnorderedUnionExpression.class,
                    AllChildrenMatcher.allMatching(QuantifierMatcher.forEach(unionLegExpressionMatcher)));
