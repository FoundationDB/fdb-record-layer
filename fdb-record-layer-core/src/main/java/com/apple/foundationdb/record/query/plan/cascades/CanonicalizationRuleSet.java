...
public class CanonicalizationRuleSet extends CascadesRuleSet {
    ...
    public static final CanonicalizationRuleSet DEFAULT = new CanonicalizationRuleSet();

    @VisibleForTesting
    @SpotBugsSuppressWarnings("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE")
    CanonicalizationRuleSet() {
        super(ALL_EXPRESSION_RULES);
    }

    @Nonnull
    public static CanonicalizationRuleSet getDefault() {
        return DEFAULT;
    }
}
