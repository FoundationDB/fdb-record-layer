...
public abstract class IndexPredicate {
     ...
     * wrapping a {@link RowNumberWindowValue} with a field ordering and a constant size comparison into
    ...
    private static RowNumberWindowPredicate tryFromRowNumberPredicate(
        ...
        if (!(valuePredicate.getValue() instanceof RowNumberWindowValue)) {
            return null;
        }
        final var rowNumberValue = (RowNumberWindowValue)valuePredicate.getValue();
