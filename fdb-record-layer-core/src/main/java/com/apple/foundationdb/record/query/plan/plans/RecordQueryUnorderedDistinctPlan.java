...
public class RecordQueryUnorderedDistinctPlan implements RecordQueryPlanWithChild {
    ...
    @Nonnull
    @Override
    public RecordQueryUnorderedDistinctPlan translateCorrelations(@Nonnull final TranslationMap translationMap, @Nonnull final List<Quantifier> translatedQuantifiers) {
