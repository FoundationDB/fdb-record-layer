...
public class AccumulatorList implements AggregateAccumulator {
    ...
    @Override
    public <M extends Message> void accumulate(@Nonnull final FDBRecordStoreBase<M> store, @Nonnull final EvaluationContext context, @Nullable final FDBRecord<M> record, @Nonnull final M message) {
