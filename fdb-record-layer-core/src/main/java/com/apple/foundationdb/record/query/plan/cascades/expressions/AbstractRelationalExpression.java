...
public abstract class AbstractRelationalExpression implements RelationalExpression {
    ...
    @Nonnull
    public abstract Set<CorrelationIdentifier> computeCorrelatedToWithoutChildren();

    @Override
    public final int hashCodeWithoutChildren() {
        return hashCodeWithoutChildrenSupplier.get();
    }

    public abstract int computeHashCodeWithoutChildren();
}
