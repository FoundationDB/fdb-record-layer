    ...
    public static class ListComparison implements Comparison {
        ...
        public int planHash(@Nonnull final PlanHashMode mode) {
            switch (mode.getKind()) {
                ...
                case STRUCTURAL_WITHOUT_LITERALS:
                    return PlanHashable.objectsPlanHash(mode, BASE_HASH, type, javaType);
                default:
                    throw new UnsupportedOperationException("Hash Kind " + mode.name() + " is not supported");
            }
        }
    ...
    public static class TextComparison implements Comparison {
        ...
        public int planHash(@Nonnull final PlanHashMode mode) {
            switch (mode.getKind()) {
                ...
                case STRUCTURAL_WITHOUT_LITERALS:
                    return PlanHashable.objectsPlanHash(mode, BASE_HASH, type, tokenizerName, fallbackTokenizerName);
                default:
                    throw new UnsupportedOperationException("Hash Kind " + mode.name() + " is not supported");
            }
        }
