...
public interface MatchCandidate {
    ...
    /**
     * Compute a list of {@link LogicalOrderingPart}s which forms a bridge to relate {@link KeyExpression}s and
     ...
     */
    @Nonnull
    List<LogicalOrderingPart> computeMatchedOrderingParts(@Nonnull MatchInfo matchInfo,
