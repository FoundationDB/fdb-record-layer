...
public class DecorrelateValuesRule extends AbstractCascadesRule<SelectExpression> implements ExplorationCascadesRule<SelectExpression> {
    ...
    @Nonnull
    private static final BindingMatcher<Quantifier.ForEach> rangeOneMatcher = forEachQuantifierWithoutNullOnEmptyOverRef(
    ...
    @Nonnull
    private static final BindingMatcher<Quantifier.ForEach> valuesQunMatcher = forEachQuantifierWithoutNullOnEmptyOverRef(exploratoryMember(valuesExpressionMatcher));
