...
public class RecordQueryRangePlan implements RecordQueryPlanWithNoChildren {
    ...
    public RecordQueryRangePlan(final int exclusiveLimit) {
    ...
    public boolean equalsWithoutChildren(@Nonnull RelationalExpression otherExpression,
        ...
        return exclusiveLimit == other.exclusiveLimit;
    }
    ...
    public int hashCodeWithoutChildren() {
        return Objects.hash(exclusiveLimit);
    }
    ...
    public int planHash(@Nonnull final PlanHashKind hashKind) {
        switch (hashKind) {
            ...
            case STRUCTURAL_WITHOUT_LITERALS:
                return PlanHashable.objectsPlanHash(hashKind, BASE_HASH, exclusiveLimit);
            default:
    ...
    public PlannerGraph rewritePlannerGraph(@Nonnull final List<? extends PlannerGraph> childGraphs) {
        ...
        dataNodeWithInfo = new PlannerGraph.DataNodeWithInfo(NodeInfo.BASE_DATA,
                ...
                ImmutableMap.of("exclusiveLimit", Attribute.gml(exclusiveLimit)));
