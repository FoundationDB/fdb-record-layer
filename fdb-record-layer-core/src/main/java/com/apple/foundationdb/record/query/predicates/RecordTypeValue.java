...
public class RecordTypeValue implements Value {
    ...
    public Value rebase(@Nonnull final AliasMap translationMap) {
        return new RecordTypeValue(translationMap.translate(identifier));
    }
    ...
    public boolean semanticEquals(@Nullable final Object other, @Nonnull final AliasMap equivalenceMap) {
        ...
        return equivalenceMap.identifiesCorrelations(identifier, ((RecordTypeValue)other).identifier);
    }
