...
public class NullableArrayTypeUtils {
    ...
    public static Optional<RecordKeyExpressionProto.Field.FanType> matchArrayWrapper(@Nonnull NestingKeyExpression nestingKeyExpression) {
        ...
        if (child.hasNesting()) {
            ...
            return mapWrappedField(firstChild);
        } else if (child.hasField()) {
            // if child is Field, check itself
            return mapWrappedField(child.getField());
        }
     ...
     */
    @Nonnull
    private static Optional<RecordKeyExpressionProto.Field.FanType> mapWrappedField(@Nonnull RecordKeyExpressionProto.Field field) {
