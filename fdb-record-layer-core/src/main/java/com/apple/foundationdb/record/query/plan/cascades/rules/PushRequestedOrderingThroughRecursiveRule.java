...
public class PushRequestedOrderingThroughRecursiveRule extends CascadesRule<RecursiveExpression> implements PreOrderRule {
    ...
    public PushRequestedOrderingThroughRecursiveRule() {
