...
public class PushFilterThroughFetchRule extends PlannerRule<RecordQueryPredicatesFilterPlan> {
    ...
    @Nonnull
    private static final ExpressionMatcher<RecordQueryPredicatesFilterPlan> root =
            TypeMatcher.of(RecordQueryPredicatesFilterPlan.class, quantifierOverFetchMatcher);
    ...
    public void onMatch(@Nonnull PlannerRuleCall call) {
        ...
        for (final QueryPredicate queryPredicate : queryPredicates) {
            final Optional<QueryPredicate> pushedPredicateOptional =
                    queryPredicate.mapLeavesMaybe(leafPredicate -> pushLeafPredicate(fetchPlan, newInnerAlias, leafPredicate));
