...
public class CardinalitiesProperty implements ExpressionProperty<CardinalitiesProperty.Cardinalities> {
    public static final ExpressionProperty<Cardinalities> CARDINALITIES = new CardinalitiesProperty();

    @Nonnull
    @Override
    public RelationalExpressionVisitor<Cardinalities> createVisitor() {
        return PlanVisitorHelpers.toExpressionVisitor(new CardinalitiesProperty.CardinalitiesVisitor());
    }
    ...
    @Nonnull
    public static Cardinalities evaluate(@Nonnull RecordQueryPlan recordQueryPlan) {
        return new CardinalitiesVisitor().visit(recordQueryPlan);
    }

    @Nonnull
    public static Cardinalities evaluate(@Nonnull Reference ref) {
        return evaluate(ref.getAsPlan());
    }

    /**
     * Visitor implementation.
     */
    public static class CardinalitiesVisitor implements RecordQueryPlanVisitor<Cardinalities> {

        private static final CardinalitiesProperty INSTANCE = new CardinalitiesProperty();

        @Nonnull
        @Override
        public Cardinalities visitUpdatePlan(@Nonnull final RecordQueryUpdatePlan updatePlan) {
            return fromChild(updatePlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitPredicatesFilterPlan(@Nonnull final RecordQueryPredicatesFilterPlan predicatesFilterPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitLoadByKeysPlan(@Nonnull final RecordQueryLoadByKeysPlan element) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitInValuesJoinPlan(@Nonnull final RecordQueryInValuesJoinPlan inValuesJoinPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitAggregateIndexPlan(@Nonnull final RecordQueryAggregateIndexPlan aggregateIndexPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitCoveringIndexPlan(@Nonnull final RecordQueryCoveringIndexPlan coveringIndexPlan) {
            if (!(coveringIndexPlan.getIndexPlan() instanceof RecordQueryIndexPlan)) {
                return Cardinalities.unknownMaxCardinality();
            }
            return visitIndexPlan((RecordQueryIndexPlan)coveringIndexPlan.getIndexPlan());
        }

        @Nonnull
        @Override
        public Cardinalities visitDeletePlan(@Nonnull final RecordQueryDeletePlan deletePlan) {
            return fromChild(deletePlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitMapPlan(@Nonnull final RecordQueryMapPlan mapPlan) {
            return fromChild(mapPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitComparatorPlan(@Nonnull final RecordQueryComparatorPlan comparatorPlan) {
            return weakenCardinalities(fromChildren(comparatorPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitUnorderedDistinctPlan(@Nonnull final RecordQueryUnorderedDistinctPlan unorderedDistinctPlan) {
            return fromChild(unorderedDistinctPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitIntersectionOnKeyExpressionPlan(@Nonnull final RecordQueryIntersectionOnKeyExpressionPlan intersectionOnKeyExpressionPlan) {
            return intersectCardinalities(fromChildren(intersectionOnKeyExpressionPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitSelectorPlan(@Nonnull final RecordQuerySelectorPlan selectorPlan) {
            return weakenCardinalities(fromChildren(selectorPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitRangePlan(@Nonnull final RecordQueryRangePlan rangePlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitExplodePlan(@Nonnull final RecordQueryExplodePlan element) {
            return Cardinalities.unknownMaxCardinality();
        }

        @Nonnull
        @Override
        public Cardinalities visitInsertPlan(@Nonnull final RecordQueryInsertPlan insertPlan) {
            return fromChild(insertPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitIntersectionOnValuesPlan(@Nonnull final RecordQueryIntersectionOnValuesPlan intersectionOnValuesPlan) {
            return weakenCardinalities(fromChildren(intersectionOnValuesPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitScoreForRankPlan(@Nonnull final RecordQueryScoreForRankPlan scoreForRankPlan) {
            return fromChild(scoreForRankPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitIndexPlan(@Nonnull final RecordQueryIndexPlan indexPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitFirstOrDefaultPlan(@Nonnull final RecordQueryFirstOrDefaultPlan element) {
            return new Cardinalities(Cardinality.ofCardinality(1L), Cardinality.ofCardinality(1L));
        }

        @Nonnull
        @Override
        public Cardinalities visitUnionOnKeyExpressionPlan(@Nonnull final RecordQueryUnionOnKeyExpressionPlan unionOnKeyExpressionPlan) {
            return unionCardinalities(fromChildren(unionOnKeyExpressionPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitFilterPlan(@Nonnull final RecordQueryFilterPlan filterPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitUnorderedPrimaryKeyDistinctPlan(@Nonnull final RecordQueryUnorderedPrimaryKeyDistinctPlan unorderedPrimaryKeyDistinctPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitTextIndexPlan(@Nonnull final RecordQueryTextIndexPlan element) {
            return Cardinalities.unknownMaxCardinality();
        }

        @Nonnull
        @Override
        public Cardinalities visitFetchFromPartialRecordPlan(@Nonnull final RecordQueryFetchFromPartialRecordPlan fetchFromPartialRecordPlan) {
            return fromChild(fetchFromPartialRecordPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitTypeFilterPlan(@Nonnull final RecordQueryTypeFilterPlan typeFilterPlan) {
            return fromChild(typeFilterPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitInUnionOnKeyExpressionPlan(@Nonnull final RecordQueryInUnionOnKeyExpressionPlan inUnionOnKeyExpressionPlan) {
            return visitInUnionPlan(inUnionOnKeyExpressionPlan);
        }

        @Nonnull
        public Cardinalities visitInUnionPlan(@Nonnull final RecordQueryInUnionPlan inUnionPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitInParameterJoinPlan(@Nonnull final RecordQueryInParameterJoinPlan element) {
            return Cardinalities.unknownMaxCardinality();
        }

        @Nonnull
        @Override
        public Cardinalities visitInComparandJoinPlan(@Nonnull final RecordQueryInComparandJoinPlan element) {
            return Cardinalities.unknownMaxCardinality();
        }

        @Nonnull
        @Override
        public Cardinalities visitFlatMapPlan(@Nonnull final RecordQueryFlatMapPlan flatMapPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitStreamingAggregationPlan(@Nonnull final RecordQueryStreamingAggregationPlan element) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitUnionOnValuesPlan(@Nonnull final RecordQueryUnionOnValuesPlan unionOnValuesPlan) {
            return unionCardinalities(fromChildren(unionOnValuesPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitUnorderedUnionPlan(@Nonnull final RecordQueryUnorderedUnionPlan unorderedUnionPlan) {
            return unionCardinalities(fromChildren(unorderedUnionPlan));
        }

        @Nonnull
        @Override
        public Cardinalities visitScanPlan(@Nonnull final RecordQueryScanPlan scanPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitInUnionOnValuesPlan(@Nonnull final RecordQueryInUnionOnValuesPlan inUnionOnValuesPlan) {
        ...
        @Nonnull
        @Override
        public Cardinalities visitDamPlan(@Nonnull final RecordQueryDamPlan damPlan) {
            return fromChild(damPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitSortPlan(@Nonnull final RecordQuerySortPlan querySortPlan) {
            return fromChild(querySortPlan);
        }

        @Nonnull
        @Override
        public Cardinalities visitDefault(@Nonnull final RecordQueryPlan element) {
            return Cardinalities.unknownCardinalities();
        }
        ...
        private Cardinalities fromQuantifier(@Nonnull final Quantifier quantifier) {
            ...
            return visit(quantifier.getRangesOver().getAsPlan());
        }
    }
