...
class OrderingValueSimplificationTest {
    ...
    void testOrderingSimplification1() {
        ...
        final var arithmeticValue =
                (Value)new ArithmeticValue.AddFn().encapsulate(CallSiteArguments.ofPositional(fieldValue2, LiteralValue.ofScalar(3)));
    ...
    void testOrderingSimplification2() {
        ...
        final var arithmeticValue =
                (Value)new ArithmeticValue.AddFn().encapsulate(CallSiteArguments.ofPositional(fieldValueB, LiteralValue.ofScalar(3)));
