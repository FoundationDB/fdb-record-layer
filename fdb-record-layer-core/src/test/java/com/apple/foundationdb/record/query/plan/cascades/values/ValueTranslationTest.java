...
public class ValueTranslationTest {
    ...
    public void testMultiLevelValueTranslation() {
        ...
        final var pPredicate = (Value)new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(fv(p, 0), LiteralValue.ofScalar(42))));
        ...
        Assertions.assertEquals(new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(fv(p_, 0, 0), LiteralValue.ofScalar(42)))), l2TranslatedPredicate);
    ...
    public void maxMatchValueWithCompositionOfTranslationMaps() {
        ...
        // p.0 + q.0.0 < n.0 - n.1.0
        final var predicate = (Value)new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(add(fv(p, 0), fv(q, 0, 0)), add(fv(r, 0), fv(r, 1, 0)))));
        ...
        final var expectedTranslatedPredicate = (Value)new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(add(fv(p_, 0, 0), fv(q_, 2)), add(fv(r_, 2, 2), fv(r_, 1)))));
    ...
    public void maxMatchDifferentCompositions() {
        ...
        // p.0 + q.0.0 < r.0 + s + u
        final var predicate = (Value)new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(add(fv(p, 0), fv(q, 0, 0)), add(add(fv(r, 0), s), u))));
        ...
        final var expectedTranslatedPredicate = (Value)new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(add(fv(p_, 0, 0), fv(q_, 2)), add(add(fv(r_, 2, 2), s_), u_))));
    ...
    public void maxMatchValueSimpleQueriedValues() {
        ...
        final var p_Alias = CorrelationIdentifier.of("P'");
        final var p = qov(pAlias, pv.getResultType());
        final var pPredicate = (Value)new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(fv(p, 0, 0),
         ...
         */
        final var l2TranslatedPredicate = pPredicate.translateCorrelations(l2TranslationMap, true);
        Assertions.assertEquals(new RelOpValue.LtFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(fv(p_, 0, 0),
    ...
    public void maxMatchVersionToQovRoot() {
        ...
        final var versionValue = (Value) new VersionValue.VersionFn().encapsulate(CallSiteArguments.ofPositional(ImmutableList.of(qrv)));
        final var pv =
