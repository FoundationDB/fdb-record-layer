...
public class QueryPlanMaxCardinalityTest extends FDBRecordStoreQueryTestBase {
    ...
    public void nonUniqueIndex() {
        ...
        RecordQuery query = RecordQuery.newBuilder()
                ...
                .build();
        assertEquals(QueryPlan.UNKNOWN_MAX_CARDINALITY, planner.plan(query).getPlan().maxCardinality(metaData));
    }
    ...
    public void uniqueIndex() {
        ...
        RecordQuery query = RecordQuery.newBuilder()
                ...
                .build();
        assertEquals(1, planner.plan(query).getPlan().maxCardinality(metaData));
    }
