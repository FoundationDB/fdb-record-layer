...
class UnnestedRecordTypeExpansionTest {
    ...
    void expandUnnestsAConstituentWithOrdinality() {
        ...
        assertEquals(metaData.getPlannerTypeForRecordType(metaData.getRecordType(OUTER)),
                typeFilter.getResultValue().getResultType());
        ...
        assertEquals(metaData.getPlannerTypeForRecordType(type).getFieldNameFieldMap().get("map_entry").getFieldType(),
    ...
    void expandUnnestsThroughANullableArrayWrapper() {
        ...
        assertEquals(metaData.getPlannerTypeForRecordType(type).getFieldNameFieldMap().get("review").getFieldType(),
