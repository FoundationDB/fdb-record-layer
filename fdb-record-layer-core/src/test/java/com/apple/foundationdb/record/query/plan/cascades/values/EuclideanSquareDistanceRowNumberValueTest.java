/*
 * EuclideanSquareDistanceRowNumberValueTest.java
 *
...
class EuclideanSquareDistanceRowNumberValueTest {
    ...
    void testConstructorWithParameters() {
        ...
        final var value = new EuclideanSquareDistanceRowNumberValue(partitioningValues, argumentValues);
        Assertions.assertNotNull(value, "EuclideanSquareDistanceRowNumberValue should be created successfully");
    }
    ...
    void testConstructorFromProto() {
        final var partitioningValues = ImmutableList.of(LiteralValue.ofScalar(1));
        final var argumentValues = ImmutableList.of(LiteralValue.ofScalar(2));
        final var originalValue = new EuclideanSquareDistanceRowNumberValue(partitioningValues, argumentValues);
        ...
        final var value = new EuclideanSquareDistanceRowNumberValue(serializationContext, proto);
        Assertions.assertNotNull(value, "EuclideanSquareDistanceRowNumberValue should be created from proto");
    }
    ...
    void testGetName() {
        ...
        Assertions.assertEquals("EuclideanSquareDistanceRowNumber", value.getName(),
                "Name should be EuclideanSquareDistanceRowNumber");
    }
    ...
    void testPlanHash() {
        final var partitioningValues = ImmutableList.of(LiteralValue.ofScalar(1));
        final var argumentValues = ImmutableList.of(LiteralValue.ofScalar(2));
        final var value1 = new EuclideanSquareDistanceRowNumberValue(partitioningValues, argumentValues);
        final var value2 = new EuclideanSquareDistanceRowNumberValue(partitioningValues, argumentValues);
        ...
        final var value3 = new EuclideanSquareDistanceRowNumberValue(partitioningValues3, argumentValues3);
    ...
    void testGetResultType() {
        ...
        Assertions.assertEquals(Type.primitiveType(Type.TypeCode.LONG), resultType,
                "EuclideanSquareDistanceRowNumberValue should have LONG result type");
    }
    ...
    void testWithChildren() {
        ...
        Assertions.assertInstanceOf(EuclideanSquareDistanceRowNumberValue.class, newValue,
                "New value should be an EuclideanSquareDistanceRowNumberValue");
    ...
    void testToValueProto() {
        ...
        Assertions.assertTrue(valueProto.hasEuclideanSquareDistanceRowNumberValue(),
                "Value proto should have EuclideanSquareDistanceRowNumberValue");
    }
    ...
    void testFromProtoStatic() {
        ...
        final var value = EuclideanSquareDistanceRowNumberValue.fromProto(serializationContext, proto);
    ...
    void testFromProtoDeserializer() {
        ...
        final var deserializer = new EuclideanSquareDistanceRowNumberValue.Deserializer();
    ...
    void testSerializationRoundTrip() {
        final var partitioningValues = ImmutableList.of(LiteralValue.ofScalar(1));
        final var argumentValues = ImmutableList.of(LiteralValue.ofScalar(2));
        final var original = new EuclideanSquareDistanceRowNumberValue(partitioningValues, argumentValues);
        final var serializationContext = new PlanSerializationContext(DefaultPlanSerializationRegistry.INSTANCE, PlanHashable.CURRENT_FOR_CONTINUATION);

        final var proto = original.toProto(serializationContext);
        final var deserialized = EuclideanSquareDistanceRowNumberValue.fromProto(serializationContext, proto);
    ...
    void testDeserializerGetProtoMessageClass() {
        ...
        Assertions.assertEquals("PEuclideanSquareDistanceRowNumberValue", protoClass.getSimpleName(),
                "Proto class should be PEuclideanSquareDistanceRowNumberValue");
    }
}
