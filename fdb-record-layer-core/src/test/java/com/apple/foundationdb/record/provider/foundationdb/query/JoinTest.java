...
public class JoinTest extends FDBRecordStoreQueryTestBase {
...
//        int bitBucketSize = 4;
//        RecordMetaDataHook hook = setupHookAndAddData();
//        final var cascadesPlanner = (CascadesPlanner)planner;
//        final var plan = cascadesPlanner.planGraph(
//                () -> constructBitmapGroupByPlan(bitBucketSize, false),
//                Optional.empty(),
...
//        {
//            final var selectBuilder = GraphExpansion.builder();
//            selectBuilder.addQuantifier(qun).addAllResultColumns(Column.of(FieldValue.ofFieldName(""),
//            final var quantifiedValue = QuantifiedObjectValue.of(qun.getAlias(), qun.getFlowedObjectType());
...
//    }
//
//    protected RecordMetaDataHook setupHookAndAddData() {
//        try (FDBRecordContext context = openContext()) {
