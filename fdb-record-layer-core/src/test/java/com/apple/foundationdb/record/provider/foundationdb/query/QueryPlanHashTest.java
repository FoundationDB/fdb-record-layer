...
public class QueryPlanHashTest extends FDBRecordStoreQueryTestBase {
    ...
    public void testSingleEqualsFilter() throws Exception {
        ...
        assertEquals(913370523, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(913370524, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(913370573, plan3.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testSingleGtFilter() throws Exception {
        ...
        assertEquals(-167290686, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-167290685, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testSingleGteFilter() throws Exception {
        ...
        assertEquals(-544375458, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-544375457, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testOrEqualsFilter() throws Exception {
        ...
        assertEquals(385591762, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(385591826, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(385593426, plan3.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testAndGtFilter() throws Exception {
        ...
        assertEquals(-1920816044, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-1920816012, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testNotEqualsFilter() throws Exception {
        ...
        assertEquals(913370524, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(913370525, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(913370574, plan3.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testNotGtFilter() throws Exception {
        ...
        assertEquals(-167290685, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-167290684, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testRank() throws Exception {
        ...
        assertEquals(-615528291, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-615528290, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testComplexQuery1g() throws Exception {
        ...
        assertEquals(-2070415596, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-2070415565, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testComplexQueryAndWithIncompatibleFilters() throws Exception {
        ...
        assertEquals(746853985, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(746853986, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void intersectionVersusRange() throws Exception {
        ...
        assertEquals(2043805138, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(2043805324, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(2043805325, plan3.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void sortedIntersectionBounded() throws Exception {
        ...
        assertEquals(-312630550, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-312630546, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void sortedIntersectionUnbound() throws Exception {
        ...
        assertEquals(575076824, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(575076888, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void collateNoIndex() throws Exception {
        ...
        assertEquals(-1306680475, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-1305756954, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
...
//        assertEquals(2024130897, plan2.planHash(PlanHashable.PlanHashKind.STRUCTURAL_WITHOUT_LITERALS));
    ...
    public void coveringSimple() throws Exception {
        ...
        assertEquals(-158312359, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-158305583, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void coveringWithAdditionalFilter() throws Exception {
        ...
        assertEquals(-1374002128, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-1374002124, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
    ...
    public void testMultiRecordTypeIndexScan() throws Exception {
        ...
        assertEquals(-501898489, plan1.planHash(PlanHashable.PlanHashKind.STANDARD));
        assertEquals(-501898488, plan2.planHash(PlanHashable.PlanHashKind.STANDARD));
