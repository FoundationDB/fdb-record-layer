...
/**
 * Plan matcher for {@link RecordQueryInValuesJoinPlan}.
 */
public class InValueJoinMatcher extends PlanMatcherWithChild {
    @Nonnull
    private final Matcher<Iterable<?>> listMatcher;

    public InValueJoinMatcher(@Nonnull Matcher<Iterable<?>> listMatcher, @Nonnull Matcher<RecordQueryPlan> childMatcher) {
        super(childMatcher);
