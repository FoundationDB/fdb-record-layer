        ...
        try (FDBRecordContext context = openContext()) {
            ...
            TestRecords4WrapperProto.RestaurantRecord restaurant = TestRecords4WrapperProto.RestaurantRecord.newBuilder()
                    ...
                    .setReviews(TestRecords4WrapperProto.RestaurantReviewList.newBuilder()
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantReview.newBuilder().setReviewer(1L).setRating(100))
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantReview.newBuilder().setReviewer(2L).setRating(0)))
                    .setTags(TestRecords4WrapperProto.RestaurantTagList.newBuilder()
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantTag.newBuilder().setValue("l'atmosphère").setWeight(10))
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantTag.newBuilder().setValue("les aliments").setWeight(70)))
                    .setCustomer(TestRecords4WrapperProto.StringList.newBuilder()
                            .addNonNullRepeatedField("jean")
                            .addNonNullRepeatedField("fantine")
                            .addNonNullRepeatedField("cosette")
                            .addNonNullRepeatedField("éponine"))
                    .build();
            recordStore.saveRecord(restaurant);
            ...
            restaurant = TestRecords4WrapperProto.RestaurantRecord.newBuilder()
                    ...
                    .setName("ABC")
                    .setReviews(TestRecords4WrapperProto.RestaurantReviewList.newBuilder()
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantReview.newBuilder().setReviewer(1L).setRating(34))
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantReview.newBuilder().setReviewer(2L).setRating(110)))
                    .setTags(TestRecords4WrapperProto.RestaurantTagList.newBuilder()
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantTag.newBuilder().setValue("l'atmosphère").setWeight(40))
                            .addNonNullRepeatedField(TestRecords4WrapperProto.RestaurantTag.newBuilder().setValue("les aliments").setWeight(20)))
                    .setCustomer(TestRecords4WrapperProto.StringList.newBuilder()
                            .addNonNullRepeatedField("gavroche")
                            .addNonNullRepeatedField("enjolras")
                            .addNonNullRepeatedField("éponine"))
                    .build();
            recordStore.saveRecord(restaurant);
