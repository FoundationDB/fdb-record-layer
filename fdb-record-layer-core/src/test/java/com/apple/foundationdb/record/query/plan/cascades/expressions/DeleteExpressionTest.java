...
/**
 * Tests for {@link DeleteExpression}.
 */
class DeleteExpressionTest {
    ...
    void toStringTranslatesEscapedProtoIdentifierBackToUserIdentifier() {
        ...
        final var deleteExpression = new DeleteExpression(scanQuantifierOver(recordType, "R"), escapedTargetRecordType);

        assertEquals("Delete(My.Record)", deleteExpression.toString());
    }
}
