...
public class RuleTestHelper {
    ...
    public static Quantifier baseT() {
        return forEach(LogicalTypeFilterExpression.newInstance(ImmutableSet.of("T"), fuseQun(), TYPE_T));
    }

    @Nonnull
    public static Quantifier baseTau() {
        return forEach(LogicalTypeFilterExpression.newInstance(ImmutableSet.of("TAU"), fuseQun(), TYPE_TAU));
    }
