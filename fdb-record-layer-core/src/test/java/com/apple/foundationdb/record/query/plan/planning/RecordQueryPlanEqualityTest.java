...
public class RecordQueryPlanEqualityTest {
    ...
    private List<Supplier<RecordQueryPlan>> planSuppliers = Arrays.asList(
            ...
            () -> new RecordQueryInParameterJoinPlan(scanPlan(), "__in_testField", Bindings.BindingType.IN, "testField2", false, false),
            () -> intersectionPlan(2, "even"),
            () -> new RecordQueryInValuesJoinPlan(scanPlan(), "__in_testField", Bindings.BindingType.IN, Arrays.asList(1, 2, 3),
                    false, false),
