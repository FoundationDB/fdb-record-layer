...
/**
 * Generate {@link RecordCursor} from {@link SpatialIndexMaintainer} using Geophile {@link SpatialJoin}.
 */
class GeophileSpatialJoin {
    ...
    public SpatialIndex<GeophileRecordImpl> getSpatialIndex(@Nonnull String indexName,
        ...
        final Space space = ((SpatialIndexMaintainer)indexMaintainer).getSpace();
        try {
