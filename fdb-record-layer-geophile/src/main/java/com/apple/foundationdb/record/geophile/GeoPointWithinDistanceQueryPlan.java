...
public class GeoPointWithinDistanceQueryPlan extends SpatialObjectQueryPlan {
    @Nonnull
    ...
    public GeoPointWithinDistanceQueryPlan(@Nonnull CoordinateValueOrParameter centerLatitude, @Nonnull CoordinateValueOrParameter centerLongitude,
    ...
    protected SpatialObject getSpatialObject(@Nonnull EvaluationContext context) {
        ...
        return BoxLatLon.newBox(centerLatitudeValue - distanceValue, centerLatitudeValue + distanceValue,
    ...
    protected BiFunction<IndexEntry, Tuple, GeophileRecordImpl> getRecordFunction() {
        if (covering) {
            return CoveringPointRecord::new;
        } else {
    ...
    public boolean equals(Object o) {
        ...
        GeoPointWithinDistanceQueryPlan that = (GeoPointWithinDistanceQueryPlan)o;
