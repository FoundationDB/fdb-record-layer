...
public abstract class SpatialObjectQueryPlan implements RecordQueryPlanWithNoChildren, RecordQueryPlanWithIndex {
    @Nonnull
    private final String indexName;
    @Nonnull
    private final ScanComparisons prefixComparisons;

    protected SpatialObjectQueryPlan(@Nonnull String indexName, @Nonnull ScanComparisons prefixComparisons) {
    ...
    public IndexScanType getScanType() {
        return SpatialScanTypes.GO_TO_Z;
    }
    ...
    public boolean equals(Object o) {
        ...
        SpatialObjectQueryPlan that = (SpatialObjectQueryPlan)o;
