...
public abstract class SpatialFunctionKeyExpression extends FunctionKeyExpression {

    protected SpatialFunctionKeyExpression(@Nonnull String name, @Nonnull KeyExpression arguments) {
    ...
    public <M extends Message> List<Key.Evaluated> evaluateFunction(@Nullable FDBRecord<M> record, @Nullable Message message, @Nonnull Key.Evaluated arguments) {
        ...
        Space space = SpatialIndexMaintainer.SPACE_LAT_LON;
     ...
     */
    public static class GeoPointZ extends SpatialFunctionKeyExpression {
     ...
     */
    public static class GeoJsonZ extends SpatialFunctionKeyExpression {
    ...
    public static class GeoWKBZ extends SpatialFunctionKeyExpression {
    ...
    public static class GeoWKTZ extends SpatialFunctionKeyExpression {
