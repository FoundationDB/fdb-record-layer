...
/**
 * Tests for GEOSPATIAL indexes.
 */
@Tag(Tags.RequiresFDB)
public class FDBSpatialQueryTest extends FDBRecordStoreQueryTestBase {
    private static final Logger LOGGER = LoggerFactory.getLogger(FDBSpatialQueryTest.class);
    ...
    protected static final Index CITY_LOCATION_INDEX = new Index("City$location",
            function(SpatialFunctionNames.GEO_POINT_Z, LOCATION_LAT_LONG),
            SpatialIndexTypes.GEOSPATIAL_GEOPHILE);
    protected static final Index CITY_LOCATION_COVERING_INDEX = new Index("City$location",
            keyWithValue(concat(function(SpatialFunctionNames.GEO_POINT_Z, LOCATION_LAT_LONG), LOCATION_LAT_LONG), 1),
            SpatialIndexTypes.GEOSPATIAL_GEOPHILE);
    protected static final Index COUNTRY_SHAPE_INDEX = new Index("Country$shape",
            function(SpatialFunctionNames.GEO_JSON_Z, concat(field("shape"), value(true))),
            SpatialIndexTypes.GEOSPATIAL_GEOPHILE);
    ...
    protected RecordQueryPlan distanceSpatialQuery(double distance, boolean covering) {
        RecordQueryPlan spatialQuery = new GeoPointWithinDistanceQueryPlan(
                        CoordinateValueOrParameter.parameter("center_latitude"),
                        CoordinateValueOrParameter.parameter("center_longitude"),
                        CoordinateValueOrParameter.value(distance),
    ...
    public void testJoin() throws Exception {
        ...
        final SpatialIndexJoinPlan plan = new SpatialIndexJoinPlan("City$location", ScanComparisons.EMPTY,
