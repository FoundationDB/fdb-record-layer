...
public class JDBCDatabaseMetaData implements RelationalDatabaseMetaData {
    ...
    public RelationalResultSet getSchemas() throws SQLException {
        return new JDBCRelationalResultSet(metaData.getSchemas());
    }
    ...
    public RelationalResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException {
        return new JDBCRelationalResultSet(metaData.getColumns(catalog, schemaPattern, tableNamePattern, columnNamePattern));
    }
    ...
    public RelationalResultSet getPrimaryKeys(String catalog, String schema, String table) throws SQLException {
        return new JDBCRelationalResultSet(metaData.getPrimaryKeys(catalog, schema, table));
    }
    ...
    public RelationalResultSet getIndexInfo(String catalog, String schema, String table, boolean unique, boolean approximate) throws SQLException {
        return new JDBCRelationalResultSet(metaData.getIndexInfo(catalog, schema, table, unique, approximate));
    }
    ...
    public RelationalResultSet getSchemas(String catalog, String schemaPattern) throws SQLException {
        //        //H2 doesn't support the more refined API version, because of how you connect to only a single DB
        //        // at a time
        ...
        //            }
        //        }
        //        return IteratorResultSet(new String[]{
        //
        //        },filteredRows,0);
