    ...
    static class RandomQueryProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(final ExtensionContext context) throws Exception {
            return Stream.of(
                    ...
                    Arguments.of(6, "select * union restaurant", "Syntax error at line 1 position 15"),
                    ...
                    Arguments.of(14, "select * from restaurant where NON_EXISTING > 10 ", "could not find field name 'NON_EXISTING'"),
