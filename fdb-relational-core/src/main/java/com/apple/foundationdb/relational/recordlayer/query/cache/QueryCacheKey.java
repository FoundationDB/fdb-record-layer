 ...
 *     <li>A bit-set of all readable indexes.</li>
...
public final class QueryCacheKey {
    ...
    private QueryCacheKey(@Nonnull final String canonicalQueryString,
        ...
        this.memoizedHashCode = Objects.hash(canonicalQueryString, schemaVersions, plannerConfiguration, auxiliaryMetadata);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(canonicalQueryString, that.canonicalQueryString) &&
    ...
    public static QueryCacheKey of(@Nonnull final String query,
                                   ...
                                   @Nonnull final String auxiliaryMetadata,
                                   @Nonnull final ImmutableSortedMap<String, Integer> schemaVersions) {
        return new QueryCacheKey(query, plannerConfiguration, auxiliaryMetadata, schemaVersions);
    }
}
