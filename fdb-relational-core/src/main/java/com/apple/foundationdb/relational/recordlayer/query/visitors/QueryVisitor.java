...
public final class QueryVisitor extends DelegatingVisitor<BaseVisitor> {
     ...
     *
     * <p>{@code LEFT} and {@code RIGHT} outer joins are supported; {@code FULL} is rejected at parse time.
     *
    ...
    public Void visitOuterJoin(@Nonnull RelationalParser.OuterJoinContext ctx) {
        ...
        Assert.thatUnchecked(joinType != OuterJoinExpression.JoinType.FULL, ErrorCode.UNSUPPORTED_QUERY,
     ...
     * <ul>
     * <li>The two quantifiers (left and right); it owns them directly.
