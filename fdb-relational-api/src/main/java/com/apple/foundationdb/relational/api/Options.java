...
public final class Options {
    ...
    public enum Name {
        ...
        /**
         * While planning, explore only the plans that are right-deep. That is, while enumerating joins, only those
    ...
    static {
        ...
        builder.put(Name.SNAPSHOT_ISOLATION, false);
    ...
    private static Map<Name, List<OptionContract>> makeContracts() {
        ...
        data.put(Name.SNAPSHOT_ISOLATION, List.of(TypeContract.booleanType()));
