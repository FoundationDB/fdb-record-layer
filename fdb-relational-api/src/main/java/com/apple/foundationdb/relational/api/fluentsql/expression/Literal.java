 ...
 *
 * @param <J> the Java type of the literal.
 * @param <P> the type of the expression.
 */
@Immutable
public interface Literal<J, P extends DataType> extends ComparableExpressionTrait<P, Expression<P>> {
    @Nullable
    J getValue();
}
